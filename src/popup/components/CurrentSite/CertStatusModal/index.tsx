...
interface CertStatusModalProps {
    isOpen: boolean;
    onRequestClose: () => void;
}

const CertStatusModal = observer(({ onRequestClose, isOpen }: CertStatusModalProps) => {
    ...
    return (
        ...
        >
            ...
            {!certStatus.isValid && CERT_STATES[originalCertStatus as keyof typeof CERT_STATES] && (
                <div className="modal__text modal__text--red modal__text--upper">
                    {translate(CERT_STATES[originalCertStatus as keyof typeof CERT_STATES])}
                </div>
            )}
